...
**v3.5-SAMMY (Canon-Review + Pflicht-Fix)**
...
**Szenen:** 4 
**Emotional Arc:** Hoffnungsschock → Wiedersehen/Wunde reißt auf → Wahrheit/Angst → Konflikt/Loyalität → „Wir lassen uns nicht trennen"
**Key Theme:** Familie ist kein Versprechen. Familie ist ein Kampf.
**POV:** **NUR Finn!**
**Setting:** Wandernde Stadt (Luftschiffe) – Gänge, Netze, versteckte Kabinen, Windgeräusche 
**Continuity:** Direkt nach K16 (Theo angeblich weg → Lumion-Plan steht). 

---

## ⚠️ PFLICHT-FIX: TIMELINE-INKONSISTENZ

**Problem:**
- K16: "Theo war hier. Vor einer Woche. Dann ging er nach Lumion."
- K17: Finn findet Theo in versteckter Kabine.
...
## SZENE 1: DAS GEFÜHL (~750 Wörter)

### SETUP

Planung mit dem Widerstand läuft noch: Karten, Routen, „unmöglich"-Listen. Finn steht am Rand, tut so, als würde er zuhören – aber sein Kopf sucht nur eins: Theo.
...
* **Team-Reaktion:**
  ...
  * Nila sieht es zuerst (Finns Gesicht/Stillstehen) und fragt nicht lang.
  * Rex will sofort los, Elara blockt Chaos mit einem Blick.
  * Finn sagt nur: „Grün. Hier." (zu wenig Worte, weil's sonst zerbricht.)
...
## SZENE 2: DAS WIEDERSEHEN (~850 Wörter)
...
Tür auf – und da ist er:
**THEO. Lebendig. Älter. Härter.** 
Kein „Wiedersehen wie früher". Eher ein Crash zweier Leben, die nicht mehr passen.

### KEY MOMENTS TO SHOW

* **Theo-Change sichtbar:** Narben/gebrauchte Hände/andere Haltung. Seine Augen scannen zuerst Gefahren, erst danach Finn. 
* **Dialogbeats aus Outline (mit Subtext):**

  * Theo: „Finn? Was zur Hölle machst du HIER?" 
...
**⚠️ SAMMY VOICE-NOTE:** 
> Bei Ausführung: NUR die Handlung (greift, lässt los). Keine Interpretation wie "als hätte er Angst, Theo zerbricht". Der Leser versteht.

### EXIT HOOK (Szene)

Theo schließt die Tür nicht. Er verriegelt sie.
Nicht weil Finn „Feind" ist – weil Theo in Kategorien von Gefahr lebt.
Und Finn merkt: Er hat seinen Bruder gefunden… aber nicht den, der gegangen ist.
...
## SZENE 3: DIE WAHRHEIT (~750–850 Wörter)
...
Theo erzählt, was er entdeckt hat – und warum er nicht zurückkonnte: **Absorption.** Champions werden durch Mord mächtig. 
Die Wahrheit ist größer als ihre Familie.

### KEY MOMENTS TO SHOW

* **Absorption als kalter Horror:** Theo benutzt keine großen Worte. Er nennt Handlungen. Konsequenzen. Namen/Begriffe aus Protokollen. (Und genau das macht's schlimm.) 
* **Theo's Motiv glasklar:**

  > „Deshalb gehe ich nach Lumion. Öffentlich." 
* **Finns Pivot:** Finns Kopf will „nach Hause", aber sein Körper weiß: Es gibt kein Zuhause, solange das System so ist.
* **Pillar-Check:** Keine „ein Element ist stärker"-Argumente. Es geht um Machtmissbrauch, nicht um Element-Hierarchie.

### EXIT HOOK (Szene)

Theo sagt „Lumion" und es klingt nicht wie eine Stadt, sondern wie ein Urteil.
Finn sieht in ihm etwas, das er nicht kennt: Bereitschaft, zu sterben, wenn's sein muss.

### CANON CHECK

* **@LAW-005:** Absorption bleibt absolut böse – keine Relativierung
* **@PIL-002:** Kein Element-Hierarchie-Argument

---

## SZENE 4: DIE BITTE (~850 Wörter)

### SETUP

Die Kabine wird zu klein für das, was zwischen ihnen steht. Finn ist endlich da – und jetzt droht Theo ihn wieder wegzuschieben.

### KONFLIKT

Finn: „Ich komme mit." 
Theo: „Nein. Das ist mein Kampf." 
Beide meinen „Schutz", beide erzeugen „Trennung".

### KEY MOMENTS TO SHOW

* **Finns Anklage (aus Outline):**

  * „Du hast versprochen, zurückzukommen. Du hast VERSAGT." 
    Nicht melodramatisch. Wie eine Wunde, die endlich Luft kriegt.
* **Theo bricht nicht „weich", sondern kurz echt:** ein winziger Moment, in dem er nicht der Kämpfer ist, sondern Bruder. Dann schiebt er's weg.
* **Team-Presence ohne POV-Wechsel:** Nila/Rex/Elara können an der Tür sein (oder draußen), aber Finn bleibt Fokus. Ihre Anwesenheit wird über Schatten/Schritte/kurze Sätze angedeutet.
* **Finns finaler Satz (aus Outline):**

  > „Jetzt bin ich hier. Und du wirst mich nicht wegschicken." 
  > Wichtig: Das ist keine Solo-Heldenpose – es ist Bindung + Konsequenz.
...
**[KAPITEL ENDE → Setup K18: DER ANGRIFF]** 
...
* [ ] 0 Filter
* [ ] Finn 14: "Grün. Hier." – zu wenig Worte weil's sonst zerbricht
...
**Qualität:** Emotional wichtigstes Kapitel bisher. Beats sind stark.
