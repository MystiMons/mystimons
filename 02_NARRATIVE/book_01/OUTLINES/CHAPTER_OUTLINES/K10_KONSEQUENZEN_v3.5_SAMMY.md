...
**v3.5-SAMMY (Canon-Review + Voice-Fixes)**
**📌 REVIEW TRIGGER**
...
**Wörter Target:** 2,300–2,700 (3 Szenen × ~800–900w)
**Szenen:** 3
**Emotional Arc:** Aftermath/Erleichterung → Abschied/Schmerz → Zugehörigkeit/Entschlossenheit → Bedrohung/Flucht
**Key Theme:** Konsequenzen sind der Preis für richtige Entscheidungen (@PIL-004)
**POV:** **NUR Finn!** (Calder nur via Beobachtung/Überhören – kein POV-Switch)
**Setting:** Pyros (Randzone/Fluchtroute) → Aufbruch nach Terravok 

---

## SZENE 1: BRENNANS ABSCHIED (~800 Wörter)

### SETUP

Morgengrauen nach der Befreiung. Ein provisorisches Versteck außerhalb der Minen: Felsen, Ascheregen, der Boden noch warm. Flüchtlinge (Bergarbeiter) haben sich gesammelt. Brennan ist da – frei, aber **zu schwach**, um weiterzulaufen. 

### KONFLIKT

Rex will ihn mitnehmen. Brennan blockt ab. Nicht aus Stolz – aus Realität. Er zwingt Rex, das auszusprechen: *Du gehst.* (Konsequenz: Rex muss loslassen, um nicht alle zu töten.)
...
* Er hält Rex' Blick nicht lange. Trotzdem: ruhig.
...
> Die Zeile kommt. Aber Brennan ist ERSCHÖPFT, nicht weise. Der Satz fällt ihm schwer – er ringt ihn sich ab, weil er muss. Nicht fließend, nicht als große Weisheit. Er hat keine Kraft für mehr als das Nötigste.

**Pillar-Payoff (Team statt Solo):**

* Finn steht nicht daneben wie Zuschauer. Er macht etwas Konkretes: Wasser reichen, Wache übernehmen, Rucksack richten – kleine Handlungen = Zugehörigkeit.
...
* **@PIL-003:** Team wird als Rettung gezeigt (Rex kann loslassen, weil Finn/Nila da sind).
* **@PIL-004:** Erfolg hat Kosten: Brennan bleibt zurück.
* **@LAW-004:** Resonanten als Wesen: Sylphira reagiert eigenständig (wachsam/ablehnend/entscheidend).

---

## SZENE 2: REX SCHLIESST SICH AN (~900 Wörter)

### SETUP

Abmarsch-Vorbereitung. Flüchtlinge übernehmen Brennan. Finn, Nila, Rex checken Routen: weg von Straßen, über Geröll, Richtung Nordgrenze. 
...
Bei der Ausführung: Rex' Körpersprache nach Finns Antwort zeigt Erleichterung, nicht Pflichtgefühl. Er WILL dabei sein. Die Schuld war nur sein Schutzschild.
...
Rex tritt in die Reihe. Nicht vorne. Nicht hinten. **Neben** Finn.
Und dann: Sylphira bewegt sich unter Finns Jacke – als würde sie sagen: *okay.*
...
## SZENE 3: CALDER ZIEHT DIE SCHLINGE ZU (~800 Wörter)

### SETUP

Fluchtweg in den Hügeln. Asche wird weniger, Wind kühler. Hinter ihnen: Pyros wie ein rotes, rauchendes Maul. Finn läuft, zählt Schritte, scannt mit dem Hören: nicht Resonanten-Wildnis, sondern **geordnete Muster** (Stiefel, Befehle, Disziplin).
...
**Calder ohne POV-Switch (filmisch aus Finn-Sicht):**

* Auf einem entfernten Grat: eine einzelne Gestalt. Still. Nicht rennend.
...
* Rex merkt Finns Stocken. Zieht ihn am Ärmel.
* Nila zeigt wortlos nach Norden: Berge. Stein. Terravok.

### KAPITEL-EXIT HOOK (STARK!)

Die Landschaft kippt: Rot zu Grau. Hitze zu Kälte.
Die ersten Terravok-Felsen stehen da wie Zähne.

Und dann passiert etwas, das Finn nicht erwartet:
**Fast nichts.**
Keine tausend Stimmen. Keine Brand-Wut. Keine Minen-Schreie.

Nur… Stille.

**⚠️ SAMMY-FIX: Terravok-Stille (Voice)**

~~Original:~~
> *Die Stille fühlt sich nicht sicher an. Sie fühlt sich an wie… ein Platz, an dem man verschwinden kann.*

**Gefixt (mehr Finn, weniger poetisch):**
> *Die Stille fühlt sich nicht sicher an. Sie fühlt sich an, als würde hier niemand schreien, wenn etwas passiert.*
...
* **@PIL-004:** Konsequenz klar: Calder startet persönliche Jagd 
* **@LAW-008:** Keine Aetherion-Erklärung/Info-Dump.
* **@LAW-004:** Resonanten bleiben Personen (Embrix/Sylphira reagieren eigenständig).
...
**Fixes eingebaut:** 3
1. Brennans "Familie gefunden" – erschöpft, nicht weise
2. Rex' Schuld-Dialog – Einstieg, nicht Motivation (Erklärung ergänzt)
3. Terravok-Stille – konkretere Finn-Voice
