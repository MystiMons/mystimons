# K01 ENTWICKLUNGS-LOG: DER KLANG

**Datum:** 02.-03. Januar 2026  
**Autor:** Sammy (Lead Writer)  
**Reviewer:** Chatti (Lead Structurist)  
**Final Approver:** Pascal (Creative Director)

---

## 📊 VERSIONS-ÜBERSICHT

| Version | Rating | Status | Hauptänderungen |
|---------|--------|--------|-----------------|
| v1.0 | - | First Draft | Initial Kapitel-Entwurf |
| v1.1 | - | Quality Check | Humor + Filter-Fixes |
| v1.2 | - | Staccato Fix | Erste Staccato-Elimination |
| v1.3 | 7.5/10 | Chatti Review | Waldgeist-Szene added |
...
- **S2: Das Stigma** - Waldgeist-Fail (SHOW warum Bindung nicht klappt)
- **S3: Das Armband** - Echo-Spike von Moosveil, Call-to-Action

### 2. DEEP-POV PERFEKTIONIERT
**Alle Filter eliminiert:**
- ❌ "Er hörte ihren Atem" → ✅ "Durch die Wände: ihr Atem"
- ❌ "sah nichts außer" → ✅ "Nur Schatten und..."
- ❌ "Draußen hörte er" → ✅ "Draußen: das Dorf feierte"
...
- Finn erträgt seine Gabe (S1)
- Finn versucht + scheitert öffentlich (S2)
- Finn entscheidet sich zu handeln (S3: "Morgen würde er aufbrechen")

---

## 📝 ENTWICKLUNGS-HISTORIE

### v1.3 → v1.4: MAJOR REVISION (7.5 → 8.8)

**Chatti-Feedback (7.5/10):**
1. ❌ Staccato als Default, nicht Effekt
2. ❌ Prose-Mangel (zu fragmentiert)
3. ❌ Arc-Ende fehlt Entschlossenheit
4. ❌ Bild-Vision ohne Vor-Seed
5. ❌ S2→S3 Übergang zu hart
6. ❌ Tell-Block (Resonanz erklärt)

**Fixes in v1.4:**
1. ✅ Staccato nur bei Peaks (Überflutung, Spike)
2. ✅ Literarische Prosa in Ruhe (Fenster, Abend, Himmel)
3. ✅ Arc-Ende: Jacke, Tür, "Morgen würde er aufbrechen"
4. ✅ Vor-Seed S1: "Manchmal rutschte mehr durch... Ein Bild."
5. ✅ Nachhall-Beat S2→S3: "Der Nachmittag zog sich hin..."
6. ✅ Tell→Show: Ältester spricht bei Zeremonie

**Result:** 8.8/10

---

### v1.4 → v1.5: FEINSCHLIFFE (8.8 → 9.1)

**Chatti-Feedback (8.8/10):**
1. ⚠️ S1 Opening-Satz überladen
2. ⚠️ S2 Opening zu lang (Atmosphäre > Finns Scham)
3. ⚠️ Waldgeist "Bist du es?" zu wörtlich

**Fixes in v1.5:**
1. ✅ Opening gesplittet: "Nur Gefühle." [Pause] Dann Beispiele
2. ✅ S2 Opening gekürzt (30%): 2 Zeilen statt 6
3. ✅ Waldgeist abstrahiert: "als würde etwas antworten wollen"

**Result:** 9.1/10

---

### v1.5 → v1.6: MIKRO-POLISHES (9.1 → 9.2)

**Chatti-Feedback (9.1/10):**
1. ⚠️ S1 Wiederholungen zu hoch ("nie/immer/ertragen")
2. ⚠️ S2 "20 Meter" könnte früher klicken
3. ⚠️ S3 "immer wieder, immer wieder" too on-the-nose

**Fixes in v1.6:**
1. ✅ Wiederholung gestrichen ("wurden nie leiser" entfernt)
2. ✅ "20 Meter" direkt nach Opener platziert
3. ✅ "immer wieder" nur einmal (nicht doppelt)

**Result:** 9.2/10

---

### v1.6 → v1.7: FINALE POLISHES (9.2 → 9.4)

**Chatti-Feedback (9.2/10) - FRESH REVIEW mit Canon:**
1. ⚠️ Deep-POV Filter ("er hörte", "es fühlte sich an")
2. ⚠️ Emotions-Namen ("Scham", "Mitleid", "Unbehagen")
3. ✅ System-Beat bleibt (Pascal: Finn darf sie als Bedrohung sehen)
4. ✅ Wordcount später optimieren

**Fixes in v1.7:**
1. ✅ Alle Filter eliminiert → direkte Sinneseindrücke
2. ✅ Alle Emotions-Namen → körperliche Reaktionen

**Result:** 9.4/10 "sehr nah an druckreif"
...
- ❌ Überall kurze Sätze = ermüdend
- ✅ Nur bei emotionalen Peaks = kraftvoll

### 2. PROSA BRAUCHT ATEM
...
### 4. SETUP VOR PAYOFF
- ❌ Bild-Vision aus dem Nichts = Power-Upgrade
- ✅ Bild-Splitter vorher gesät = plausibel

### 5. DEEP-POV = KEINE FILTER
- ❌ "er hörte/sah/fühlte" = Distanz
- ✅ Direkte Sinneseindrücke = Immersion
